...
test.describe('SC-SS-01 — Pre-run state', () => {
  ...
  test('SC-SS-01b: Pre-run state shows "98 endpoints" placeholder', async ({ page }) => {
    ...
    // (totalTests || '98' → '98' before any test run; corrected to match backend/routers/test.py
    // test_cases count of 98 after v7.5 EPIC-02 ST-02 added GET/POST /price-alerts and
    // DELETE /price-alerts/{id} (BLG-FE-116) and EPIC-03 ST-03 added the 6 bulk-actions-toolbar
