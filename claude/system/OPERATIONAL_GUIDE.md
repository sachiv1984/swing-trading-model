...
**Source prompt:** `claude/system/release_planning_prompt.md` (v2.36)
...
**Source prompt:** `claude/system/execution_prompt.md` (v3.42)
...
| Release Engine Source | `claude/system/release_planning_prompt.md` v2.36 |
