...
**Source prompt:** `claude/system/sprint_planning_prompt.md` (v3.5)
**Owner:** PMO Lead  
...
| Sprint Planning Engine | `claude/system/sprint_planning_prompt.md` v3.5 |
...
|---------|------|----------------|
| 4.00 | 2026-05-22 | **sprint_planning_prompt.md v3.4→v3.5 — staging-only AC designation guidance (OA-04, v3.9 post-ship closure LL-v3.9-P3-2).** §7 source prompt header updated v3.4→v3.5. §14 Sprint Planning Engine v3.4→v3.5. §14 Version 3.99→4.00/2026-05-22. Change: Section 7 (Acceptance Criteria Standard) — staging-only evidence designation paragraph added for network-dependent ACs: flag ACs that cannot be verified in CI with `[staging-only evidence]` at planning time; designation pre-stages backlog filing and prevents surprise P3 notations at execution. Authority: Head of Specs Team (OA-04, v3.9 post-ship closure, 2026-05-22). |
