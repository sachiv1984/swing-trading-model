...
**Status:** Active
**Version:** 3.73
**Last Updated:** 2026-09-07 (post-ship closure 2026-09-03__release-v9.1 outstanding-actions resolution, Head of Specs Team direct action — STEP 3.1.A step 3 gains a confirming note that no dedicated STEP 3.2.C is needed for the PR-already-merged precondition: §3.1.C already inherits it by cross-reference, §3.1.B/§3.1.D do not have the engine committing directly); prior — 2026-09-07 (post-ship closure 2026-09-03__release-v9.1 outstanding actions, Head of Specs Team direct action — STEP 3.1.A step 3 gains a PR-already-merged precondition before committing to an EPIC branch once its PR is open (LL-v9.1-P3-01) and an explicit never-amend-a-pushed-commit guardrail (LL-v9.1-P3-02)); prior — 2026-09-03 (post-ship closure 2026-08-21__release-v9.0 outstanding actions, Head of Specs Team direct action — STEP 3.1.A step 10a gains a same-step self-verification read-back after the deviations_filed write (LL-v9.0-P3-01) and a resolving-commit deviation-closure discipline requirement (LL-v9.0-P4-01, BLG-GOV-315); STEP 3.1.A step 12's roll-up backstop gains a qa_evidence cross-check extension (LL-v9.0-P4-02)); prior history retained — see prior entries in version control.
...
>
> **Never amend a pushed commit (LL-v9.1-P3-02):** Once a commit has been pushed to the remote `exec/<cycle_id>/EPIC-xx` branch, a follow-up fix must be a **new** commit — never `git commit --amend` a commit already on `origin`. If `--amend` is used by mistake, git's non-fast-forward push rejection is a safety net, not a green light: resolve with `git reset --soft <original-sha>` + a fresh commit, never a force-push. Found twice in immediate succession at `2026-09-03__release-v9.1` (EPIC-01's `8be831f5`, EPIC-02's `15db3691`) — both caught by push rejection before any public history was rewritten, but the mistake itself is preventable rather than merely recoverable.
>
