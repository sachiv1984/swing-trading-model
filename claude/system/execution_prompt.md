...
**Status:** Active
**Version:** 3.74
**Last Updated:** 2026-09-09 (post-ship closure 2026-09-07__release-v9.2 outstanding-actions resolution, Head of Specs Team direct action — STEP 4 step 3a gains a same-step self-verification read-back (LL-v9.2-P3-01), mirroring step 10a's existing fix; STEP 3.1.A's never-amend-a-pushed-commit guardrail (LL-v9.1-P3-02) extended to explicitly cover the failed-intermediate-commit trigger path (LL-v9.2-P3-02)); prior — 2026-09-07 (post-ship closure 2026-09-03__release-v9.1 outstanding-actions resolution, Head of Specs Team direct action — STEP 3.1.A step 3 gains a confirming note that no dedicated STEP 3.2.C is needed for the PR-already-merged precondition); prior — 2026-09-07 (post-ship closure 2026-09-03__release-v9.1 outstanding actions, Head of Specs Team direct action — STEP 3.1.A step 3 gains a PR-already-merged precondition (LL-v9.1-P3-01) and an explicit never-amend-a-pushed-commit guardrail (LL-v9.1-P3-02)); prior history retained — see prior entries in version control.
