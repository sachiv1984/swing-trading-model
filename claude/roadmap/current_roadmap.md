...
### Dashboard & Trade-Plan UX Hardening — carried forward from v7.2 (Sprint 1 shipped 2026-07-15; 3 implementation items unblocked, awaiting next release planning)

Originally anchored at roadmap rebalance `2026-07-15__scheduled` (STEP 8.1, Option (a)) as an 8-item v7.2 Now-horizon section. 5 of the 8 items (the pre-implementation readiness/audit passes) shipped in cycle `2026-07-15__release-v7.2` and have been retired — see `roadmap_archive.md` RA:v7.2. The 3 UX implementation items below were sequencing-gated on those readiness passes; both gate conditions closed this cycle, so all three are now unblocked and ready for the next `plan release` to scope.
