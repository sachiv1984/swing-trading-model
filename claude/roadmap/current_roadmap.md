...
**Next planned release:** [TBD] — `BLG-FE-115/116/117/118` remain unblocked (readiness passes complete, §13 pre-checks PASS where applicable — RISK-05 confirmed PASS for BLG-FE-115/118 at v7.4 Design Gate) and ready for scoping at next `plan release`, subject to a fresh Design Gate pass once real design artefacts exist per `AMD-20260717-01`
