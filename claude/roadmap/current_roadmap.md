...
**v7.5** — UI Feature Expansion Continuation (Command Palette, Alerts, Bulk Actions, Saved Filters) — ✅ Complete — Shipped 2026-07-20 — cycle: 2026-07-17__release-v7.5
**Next planned release:** v7.6 — PDF / print-friendly export — anchor scope named DL-072 (see §3)
...
| P&L export reconciliation | BLG-FEAT-79 | M | PO-directed capacity-fill addition (DL-073, 2026-07-20). Audit trail reconciliation, no UI. |
| Error-response envelope standardisation | BLG-BE-65 | M | PO-directed capacity-fill addition (DL-073). Backend audit + doc, no UI. |
| OpenAPI-derived fixture library | BLG-QA-114 | M | PO-directed capacity-fill addition (DL-073). Test infra, no UI. |
| Idempotent batch-job pattern audit | BLG-BE-62 | M | PO-directed capacity-fill addition (DL-073). Backend audit, no UI. |
| Consolidated monthly AI cost view | BLG-FEAT-77 | M | PO-directed capacity-fill addition (DL-073). Observable UI (new summary view) — Design Gate applies (RISK-01). |
| Ticker/market input sanitisation regression suite | BLG-QA-69 | M | PO-directed capacity-fill addition (DL-073). Backend test suite, no UI. |
