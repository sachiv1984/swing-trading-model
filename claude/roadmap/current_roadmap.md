...
|Setup Quality Score      |PT-04|M     |Deterministic score from own trade history; gate: 20+ closed trades; depends on PT-01 — ⏸️ Parked (v3.6/v3.7/v3.8/v3.9/v4.0 conditional defers — 5 consecutive cycles; gate not met; PO decision 2026-05-19 to park formally; v5.3 re-verification 2026-06-09: 6 closed trades / 11 total — gate still NOT MET; v5.6 re-verification 2026-06-16: last verified 6 closed trades (2026-06-09); production DB not accessible from CI — trajectory unchanged at ~0.5/month; gate still NOT MET — re-open when 20+ closed trades confirmed)|
