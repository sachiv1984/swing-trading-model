...
**v7.4** — UI Feature Expansion Readiness Pass — ✅ Complete — Shipped 2026-07-17 — cycle: 2026-07-17__release-v7.4
**Next planned release:** v7.5 — UI Feature Expansion continuation (Command Palette, Alerts, Bulk Actions, Saved Filters) — anchor scope named DL-071 (see §3)
...
### v7.5 — UI Feature Expansion continuation

<!-- roadmap-annotation-marker: RA:v7.5:2026-07-17__formalization -->
...
|---|---|---|---|
| Command palette | BLG-FE-115 | — | P1; readiness pass `BLG-SPEC-91` shipped v7.3; §13 pre-check PASS (RISK-05); dependency (`cmdk`) and supporting UX/QA work delivered in `BLG-SPEC-95` (v7.4) |
| Custom price alerts | BLG-FE-116 | — | P1; readiness pass `BLG-SPEC-92` shipped v7.3 — §13 pre-check PASSED (RISK-03 cleared); no design-artefact production yet scheduled for a future release — see `AMD-20260717-01` Amendment Item B |
