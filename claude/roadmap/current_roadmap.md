...
**Next planned release:** v7.3 — Dashboard/Trade-Plan/Navigation UX continuation — anchor scope named DL-068 (see §3)
...
### v7.3 — Dashboard/Trade-Plan/Navigation UX continuation

<!-- roadmap-annotation-marker: RA:v7.3:2026-07-16__formalization -->

Anchored `2026-07-16` — formalizes the PO scope-naming decision recorded at roadmap rebalance `2026-07-16__scheduled` (see `decision_log.md` DL-068). This section completes that decision's write step out-of-band: `roadmap_prompt.md` STEP 8.1 (Empty Now Horizon Gate) did not fire that cycle because condition 1 (empty Now horizon) was false — 3 items were already carried, unversioned, from v7.2's partial retirement — so the engine's own Option (a)/(b) mechanism had no path to formally version-label them. Flagged as a governance-gap backlog item (BLG-GOV, filed same session) for a future process fix.
...
|---|---|---|---|
| Trade-plan-to-execution linkage UX ("Start Trade from Plan") | BLG-FE-109 | M (~1–2 days) | P1; unblocked 2026-07-15 (BLG-SPEC-89 readiness pass complete) — directly targets the SI-02 linked-trade-plan gap from the UX side |
| Dashboard empty/first-run state coverage | BLG-FE-110 | S–M (~0.5–1 day) | P1; unblocked 2026-07-15 (BLG-SPEC-90 readiness pass complete) |
| Dashboard briefing visual hierarchy | BLG-FE-111 | S (~0.5 day) | P1; unblocked 2026-07-15 (BLG-SPEC-90 readiness pass complete) |
| Command palette | BLG-FE-115 | — | P1; named as anchor scope 2026-07-16 (`2026-07-16__scheduled` STEP 2.4/7.1 response) — effort/readiness to be confirmed at `plan release` |
| Custom price alerts | BLG-FE-116 | — | P1; named as anchor scope 2026-07-16 |
