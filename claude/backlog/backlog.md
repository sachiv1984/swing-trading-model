...
**Priority:** P2 (Medium) | **Type:** Product Feature / Growth | **Owner:** Product Owner | **Source:** IDEA-product-owner-20260717-02 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Frontend / UX Infrastructure | **Owner:** Base44 Frontend Prompt Owner | **Source:** IDEA-base44-frontend-20260717-02 | **Effort:** M | **Provisional-Target:** v7.4

> ⚠️ **Stale target notice (groom backlog 2026-07-17):** `v7.4` shipped 2026-07-17 (cycle `2026-07-17__release-v7.4`) without this item — it carried `Provisional-Target: v7.4` but was never named in the roadmap's STEP 8.1 anchor scope, per the v7.4 scope document's "Items explicitly deferred" table. Provisional-Target needs PO update to the next release this is scoped into.
...
Added 2026-07-20 (release planning `2026-07-20__release-v7.6`); expanded same-day 2026-07-20 (PO-directed capacity-fill reopen, DL-073 — ST-03 through ST-08 added post-publish). 8 items. ST-01/EPIC-01 conditional pending Design Gate (RISK-01); ST-07/EPIC-07 conditional pending Design Gate (RISK-01, extended); ST-02/03/04/05/06/08 have no Design Gate dependency (documentation/backend/test-only, no observable UI).
...
| ST-03 | EPIC-03 | `BLG-FEAT-79` | Reconcile realised P&L export against trade_plan closes |
| ST-04 | EPIC-04 | `BLG-BE-65` | Standardise error-response envelope across all routers |
| ST-05 | EPIC-05 | `BLG-QA-114` | Standardise mock payload fixtures against openapi.yaml schema |
| ST-06 | EPIC-06 | `BLG-BE-62` | Idempotent nightly batch-job pattern audit |
| ST-07 | EPIC-07 | `BLG-FEAT-77` | Consolidated monthly AI cost view (Gemini + Claude) |
| ST-08 | EPIC-08 | `BLG-QA-69` | Ticker/market input sanitisation regression suite |
