...
## Release Slice v7.5 (in progress)

<!-- release-plan-marker: RP:v7.5:2026-07-17__release-v7.5 -->

*Cycle: `2026-07-17__release-v7.5`. Authoritative backlog slice: `claude/cycles/2026-07-17__release-v7.5/stage4_backlog_slice.md`. Ephemeral — removed at next `groom backlog` run after this cycle closes. All 4 items conditional (not firm) pending Design Gate — see RISK-01.*

| ST-ID | Backlog Item | EPIC | Status |
|-------|--------------|------|--------|
| ST-01 | BLG-FE-115 | EPIC-01 | in_scope_conditional |
| ST-02 | BLG-FE-116 | EPIC-02 | in_scope_conditional |
| ST-03 | BLG-FE-117 | EPIC-03 | in_scope_conditional |
| ST-04 | BLG-FE-118 | EPIC-04 | in_scope_conditional |
