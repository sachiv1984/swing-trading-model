...
**Effort:** M (~1–2 days)
**Provisional-Target:** v7.4

> ⚠️ **Stale target notice (groom backlog 2026-07-17):** `v7.4` shipped 2026-07-17 (cycle `2026-07-17__release-v7.4`) without this item — removed pre-seal by `AMD-20260717-01` (Design Gate blocked). Provisional-Target needs PO update to the next release this is scoped into.
...
> ⚠️ **Stale target notice (groom backlog 2026-07-17):** `v7.4` shipped 2026-07-17 (cycle `2026-07-17__release-v7.4`) without this item — removed pre-seal by `AMD-20260717-01` (Design Gate blocked; no design-artefact production was scheduled for this item anywhere in the v7.4 plan — see Amendment Item B, `lessons_learnt_cycle.md`). Provisional-Target needs PO update to the next release this is scoped into, with explicit Head of UX & Design artefact assignment.
