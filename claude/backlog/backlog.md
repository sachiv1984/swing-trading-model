...
### BLG-FE-123 — `SystemStatus.js` `categorizeEndpoint()` missing `/price-alerts` and `/saved-filters` branches
**Priority:** P3 (Low) | **Type:** Frontend / Technical Debt | **Owner:** Frontend Specifications & UX Documentation Owner | **Source:** Recurrence escalation, `2026-07-17__release-v7.5` closure, carried across 3 Post-Ship Closure cycles (v7.5→v7.6→v7.7) pending "next roadmap review"; filed as a backlog item by roadmap rebalance `2026-07-24__scheduled` STEP 0 since the fix is application source code outside the Roadmap Engine's write scope | **Effort:** XS | **Provisional-Target:** TBD

**Problem**
`src/pages/SystemStatus.js`'s `categorizeEndpoint()` function has no `includes()` branch for the `/price-alerts` or `/saved-filters` endpoint paths (both shipped since v7.5/v7.4 respectively). Both endpoints currently degrade gracefully to the `'Other'` category rather than their correct functional grouping — not a correctness bug (no wrong data shown, nothing broken), but a categorisation gap that has persisted across 3 releases.

**Scope**
Add `/price-alerts` and `/saved-filters` `includes()` branches to `categorizeEndpoint()`, grouping them under the appropriate existing category (or a new one if neither fits) consistent with the function's existing pattern.

**Acceptance Criteria:**
- `categorizeEndpoint('/price-alerts')` and `categorizeEndpoint('/saved-filters')` (and their sub-paths) return a category other than `'Other'`
...
**Owner:** Backend Engineering Patterns Owner
**Source:** IDEA-backend-engineering-20260708-01 (IW-20260708-01) — Backlog (gate-conditional); rebalance 2026-07-08__scheduled
**Effort:** M (~2–3 days)
**Provisional-Target:** Unscheduled
**Gate criteria:** None

**Problem**
List endpoints currently use 3 different pagination styles (offset/limit, cursor-based, and page-number based) depending on when each was built, with no documented convention.

**Scope**
- Audit all paginated endpoints; document current styles
- Define one canonical pattern in `backend_engineering_patterns.md`; migrate endpoints opportunistically (not a single big-bang migration)

**Acceptance Criteria**
- Canonical pattern documented
- At least the next 2 new/modified list endpoints follow it
...
**Priority:** P2 (Medium) | **Type:** Backend Engineering / Technical Debt | **Owner:** Backend Engineering Patterns Owner | **Source:** IDEA-backend-engineering-20260724-01 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Frontend / Accessibility | **Owner:** Base44 Frontend Prompt Owner | **Source:** IDEA-base44-frontend-20260724-02 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Security / Process | **Owner:** Cybersecurity & Trust Lead | **Source:** IDEA-cybersecurity-20260724-01 | **Effort:** S | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Security | **Owner:** Cybersecurity & Trust Lead | **Source:** IDEA-cybersecurity-20260724-02 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** QA / Process | **Owner:** Director of Quality | **Source:** IDEA-director-of-quality-20260724-01 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Product Feature / Reporting | **Owner:** Financial Reporting & Records Owner | **Source:** IDEA-financial-reporting-20260724-01 | **Effort:** S | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Product Feature / FinOps | **Owner:** FinOps & Resource Architect | **Source:** IDEA-finops-20260724-01 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** QA / Backend Engineering | **Owner:** Head of Engineering | **Source:** IDEA-head-of-engineering-20260724-01 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Operations / CI Tooling | **Owner:** Head of Specs Team | **Source:** IDEA-head-of-specs-20260724-01 | **Effort:** S | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Frontend / Accessibility | **Owner:** Head of UX & Design | **Source:** IDEA-head-of-ux-20260724-02 | **Effort:** S | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Product Feature | **Owner:** Product Owner | **Source:** IDEA-product-owner-20260724-01 | **Effort:** M | **Provisional-Target:** TBD
...
**Priority:** P2 (Medium) | **Type:** Product Feature / Notifications | **Owner:** Product Owner | **Source:** IDEA-product-owner-20260724-02 | **Effort:** S | **Provisional-Target:** TBD
