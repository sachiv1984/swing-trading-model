...
**Last Updated:** 2026-08-21 (session — 1 new item added: BLG-GOV-314, governance_sync.yml auto-close gap on split work/state commits — synced onto this branch from main); prior — 2026-08-21 (session — 1 new item added: BLG-TECH-18, npm dependency tree production-build regression found during ST-27's quarterly upgrade pass); prior — 2026-08-21 (session — 1 new item added: BLG-BE-110, move raw SQL execution out of analytics.py/digest.py routers into service/database layers); prior history retained — see prior entries in version control.
