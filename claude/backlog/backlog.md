...
**Last Updated:** 2026-08-10 (session — 1 new item added: BLG-FE-147); prior — 2026-08-08 (session — 2 new items added: BLG-GOV-292, BLG-GOV-293); prior — 2026-08-08 (release planning 2026-08-08__release-v8.5 — 25 items' `Provisional-Target` field updated `TBD`/`Unscheduled` → `v8.5`; `## v8.5 Release Slice` ephemeral section appended); prior history retained — see prior entries in version control.
