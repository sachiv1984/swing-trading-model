...
Added 2026-07-21 (release planning `2026-07-21__release-v7.7`). 11 items. EPIC-01 through EPIC-04 conditional pending Design Gate (RISK-02); EPIC-05 through EPIC-11 no Design Gate dependency.

| ST-ID | EPIC | Backlog source | Title |
|-------|------|-----------------|-------|
| ST-01 | EPIC-01 | `BLG-FEAT-75` | SI-04 Strategy Version Comparison |
| ST-02 | EPIC-02 | `BLG-FE-114` | Consolidate notification/digest surfaces |
| ST-03 | EPIC-03 | `BLG-FE-113` | Confirm AiDailyBriefing light-theme rendering |
| ST-04 | EPIC-04 | `BLG-FE-120` | Shared toast/notification primitive for alert-style UI |
| ST-05 | EPIC-05 | `BLG-FEAT-80` | Investigate UX nudge to accelerate SI-02 trade-count gate |
| ST-06 | EPIC-06 | `BLG-OPS-108` | CI curl response validation (daily-snapshot.yml) |
| ST-07 | EPIC-07 | `BLG-GOV-28` | PT-04 §13 compliance review (retroactive) |
| ST-08 | EPIC-08 | `BLG-QA-104` | numpy-scalar regression coverage for create_rebalance_exit_signal |
| ST-09 | EPIC-09 | `BLG-BE-63` | Nightly backtest job idempotency check |
| ST-10 | EPIC-10 | `BLG-OPS-110` | Nightly backtest job monitoring/alerting |
| ST-11 | EPIC-11 | `BLG-QA-102` | Automate endpoint-count drift check (CLAUDE.md §2) |

`BLG-FEAT-73`/`BLG-FEAT-74` (also named `v7.7` roadmap anchors) are **not** part of this slice — see `release_plan.md` §Scope and `decisions--2026-07-21__release-v7.7.md`.

Canonical source: `claude/cycles/2026-07-21__release-v7.7/stage4_backlog_slice.md`
