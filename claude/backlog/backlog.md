...
**Effort:** M (~1–2 days)
**Provisional-Target:** v2.7 (or when system becomes multi-user)
...
<!-- BLG-FE-11 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-FE-12 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-FE-13 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-FE-10 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-FE-09 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->
...
<!-- BLG-BE-08-GAP-01 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

---

<!-- BLG-BE-09-GAP-01 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-BE-09-GAP-02 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->
...
<!-- BLG-QA-07 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-QA-08 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-QA-09 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->

<!-- BLG-QA-10 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->
...
**Effort:** L (~3–5 days)
**Provisional-Target:** v2.7 (not addressed in v2.5 or v2.6 — deprioritised both cycles)
...
<!-- BLG-GOV-15 — Archived to backlog_archive.md 2026-04-13 (v2.6 post-ship closure) -->
...
**Scope**
- Assess and implement one or more of: (a) GitHub Actions workflow that posts a PR comment reminder on EPIC PR merge; (b) a `sprint_close_required` detection flag surfaced at delivery verification STEP -1 with a clearer recovery path message; (c) a mandatory `run sprint` step documented in a contributor checklist or CLAUDE.md
- Implement the chosen option and validate it addresses the recurrence pattern
- Update `execution_prompt.md` or `CLAUDE.md` as appropriate; version-bump and log per §6 checklist

**Acceptance Criteria**
- Chosen mechanism implemented and committed
- Third recurrence pattern explicitly addressed in the chosen artefact
- No "Sprint Close not triggered" recurrences in the next two cycles after fix is applied

---

### BLG-GOV-18 — Require QA evidence sign-off block to be complete before PR is raised
**Priority:** P2 (Medium)
**Type:** Governance Process
**Owner:** Director of Quality
**Source:** lessons_learnt_cycle.md Phase 3, 2026-04-11__release-v2.6 — EPIC-02 PR #219 merged with blank DoQ sign-off — 2026-04-13
**Effort:** XS (<1h)
**Provisional-Target:** v2.7

**Problem**
In v2.6, EPIC-02's `qa_evidence_EPIC-02.md` was in "Pending QA Sign-off" status when PR #219 was raised and merged. The DoQ sign-off block was missing entirely and had to be added post-merge at sprint close recovery. A PR merged without a complete DoQ sign-off block means the merge gate's QA condition was never formally observed, creating an audit gap even when the underlying evidence is sound.

**Scope**
- Add an explicit gate to `execution_prompt.md §3.2.B` (Open PR step): "Do not open the PR until `qa_evidence_EPIC-xx.md` DoQ sign-off block contains a non-blank Date field"
- Update the `commit-check` skill pre-commit checklist to flag if the QA evidence file for the current EPIC has a blank sign-off Date
- Version-bump `execution_prompt.md`; update `OPERATIONAL_GUIDE §14`; append `prompt_change_log.md` entry

**Acceptance Criteria**
- `execution_prompt.md §3.2.B` explicitly gates PR creation on a non-blank DoQ sign-off Date in `qa_evidence_EPIC-xx.md`
- `commit-check` skill raises a warning if any in-scope EPIC's `qa_evidence` has a blank Date field
- No EPIC is merged in v2.7 with a blank `qa_evidence` sign-off Date at PR open time

---

### BLG-GOV-19 — Define formal autonomous DoQ sign-off class for code-review-only EPICs
**Priority:** P2 (Medium)
**Type:** Governance Process
**Owner:** Director of Quality
**Source:** lessons_learnt_cycle.md Phase 3 + Phase 4, 2026-04-11__release-v2.6 — Tier 2 sign-off advisory fired all 4 EPICs — 2026-04-13
**Effort:** S (~0.5d)
**Provisional-Target:** v2.7

**Problem**
For purely autonomous EPICs where all stories are verified by code review with no staging or interactive UI behaviour, the engine signs the DoQ sign-off block as "Sprint Execution Engine". The delivery verification STEP -1.3 Tier 2 check fires for every such EPIC because the signer is not literally "Director of Quality". This occurred in v2.5 and v2.6, requiring a human DoQ counter-sign at every delivery verification preflight — adding unnecessary friction for work whose evidence method (code review) is appropriate and sufficient and whose quality integrity is not in question.

**Scope**
- Define an "autonomous DoQ" sign-off class in `execution_prompt.md §3.2.A`: applicable when all stories in the EPIC are `autonomous`, all AC verified by code review, no observable UI behaviour, and no staging run required
- Define explicit qualifying criteria (checklist or table) for this class
- Update `delivery_verification_prompt.md` STEP -1.3 Tier 2 check to recognise the autonomous DoQ class as a compliant sign-off (no Tier 2 flag for qualifying EPICs)
- Version-bump both prompts; update `OPERATIONAL_GUIDE §14`; append `prompt_change_log.md` entries for each
...
- v2.7 sprint produces zero Tier 2 compliance advisories for correctly-classified autonomous EPICs
...
**Cycle:** 2026-04-11__release-v2.6 | **Status:** Closed — Shipped 2026-04-13 (Verified_with_deviations) | **Published:** 2026-04-11
