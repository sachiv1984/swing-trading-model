...
| Backfill `prompt_change_log.md` entries for release_planning_prompt.md, design_gate_prompt.md, amendment_cycle_prompt.md, roadmap_prompt.md version gaps | Head of Specs Team | No (advisory) | **Resolved** — 7 entries prepended 2026-04-06 |
