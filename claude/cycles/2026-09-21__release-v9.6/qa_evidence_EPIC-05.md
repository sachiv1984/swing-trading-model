...
**Test scenarios used:** `tests/test_trade_plan_audit_log.py` (ST-21, 6 tests, unchanged behaviour) plus a full backend suite re-run (1685 passed / 3 skipped / 7 pre-existing unrelated failures)
