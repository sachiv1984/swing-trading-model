  ...
  return (
    <div className="bg-slate-800 rounded-lg p-3 border border-slate-700">
      ...
      <div className="flex items-end justify-between gap-2">
        <div>
          <p className="text-xs text-slate-500 mb-0.5">Backtest</p>
...
function Panel1({ backtest, actual, lastImportedAt }) {
  ...
  return (
    <section data-testid="benchmark-panel-1">
      ...
      {!backtest ? (
        <p className="text-sm text-slate-500 italic" data-testid="benchmark-no-data">
  ...
  if (!rows || rows.length === 0) {
    return (
      <section data-testid="benchmark-panel-2">
        ...
        <p className="text-sm text-slate-500 italic">No yearly data available.</p>
      </section>
    );
  }
...
function Panel3({ backtestTrades, actualTrades, toggleMode, onToggleMode }) {
  ...
  return (
    <section data-testid="benchmark-panel-3">
      ...
      {rows.length === 0 ? (
        <p className="text-sm text-slate-500 italic" data-testid="benchmark-trades-empty">
    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto" data-testid="strategy-benchmark-page">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Compare live trades against production backtest results</p>
          </div>
        </div>
        <button
          onClick={fetchData}
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <label className="text-xs text-slate-500 shrink-0">Year</label>
        ...
        {/* Market filter */}
        <div className="flex items-center gap-2">
          <label className="text-xs text-slate-500 shrink-0">Market</label>
