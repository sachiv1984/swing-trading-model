    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-slate-600 dark:text-slate-400">SPY (US)</span>
      ...
      <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-slate-600 dark:text-slate-400">FTSE (UK)</span>
          <span className="text-lg">🇬🇧</span>
        </div>
        <div className="flex items-center gap-2">
          {ftseStatus?.isRiskOn ? (
      ...
      <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
        <span className="text-sm text-slate-600 dark:text-slate-400 block mb-2">FX Rate</span>
