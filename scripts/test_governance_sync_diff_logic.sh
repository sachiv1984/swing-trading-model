...
# incident's shape.
#
# ST-16 (BLG-QA-165, EPIC-03, v9.5): this script now sources the real
# detect_newly_done_st_ids() from scripts/governance_sync_lib.sh — the same
# function .github/workflows/governance_sync.yml's "Parse Commits for
# Governance" step sources — instead of maintaining its own hand-copied
# duplicate. Both regression test scripts and the workflow now exercise
...
RESULT_1=$(detect_newly_done_st_ids "cffda202" "8350caba")
...
RESULT_2=$(detect_newly_done_st_ids "b897b28" "04d47ab")
...
RESULT_3=$(detect_newly_done_st_ids "912ea30a" "1cbd31ee")
