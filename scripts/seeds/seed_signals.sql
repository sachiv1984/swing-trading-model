...
--   1 converted signal    — converted to a position (status = converted)
--
...
CROSS JOIN (VALUES
    ...
    -- Converted to position (excluded from active view)
    ('TSCO',   'UK', '2026-04-10', 4, 5.90,  310.20,  310.20, 5.40, 0.71, 290.00,  80, 248.16,  248.16,  'converted')
