...
> **Standing notice:** This document records decisions made during the pre-alignment meeting for roadmap item 3.2. It is not a canonical specification. It exists to provide rationale and traceability for the specification and scope documents that follow. This document is now superseded — the feature shipped in v1.6 (2026-02-20). It is retained for traceability. The canonical documents produced by these decisions are listed in the Specs Requiring Updates table below and remain authoritative.
