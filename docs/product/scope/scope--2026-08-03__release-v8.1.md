...
Superseded by: v8.1 ship — 2026-08-03
Changelog: docs/product/changelog.md#v8.1
Verification report: claude/cycles/2026-08-03__release-v8.1/verification_report.md
Cycle: 2026-08-03__release-v8.1

## Release Scope — v8.1 User-Feature Push & Governance Debt Clearance

### Items in scope
| S2-ID | Epic | Description |
|-------|------|-------------|
| S2-01 | EPIC-01 | BLG-FE-137 — Trade Plan tag-suggestion buttons use `onMouseDown`, not keyboard-operable |
| S2-02 | EPIC-02 | BLG-OPS-127 — Recurring manual `pg_dump` backup schedule for production Supabase |
...
| S2-10 | EPIC-04 | BLG-QA-115 — Staging sign-off: custom price alert live delivery firing |
...
| S2-19 | EPIC-07 | BLG-GOV-284 — Implement per-EPIC `execution_state.json` files (Option 1) |

### Items explicitly deferred
| Item | Reason | Target |
|------|--------|--------|
| BLG-FEAT-73 / BLG-FEAT-74 | SI-02 gate NOT MET / §13 pre-clearance not run; perennial-return disposition, Option (a) with updated evidence | Unscheduled, pending gate clearance |
...
| BLG-FEAT-45 | Gate clears 2026-08-05, inside likely sprint window — STEP 1.4b mandates conditional classification for within-sprint date gates | Next cycle, pending gate owner confirmation |
...
| Remaining ~140 ungated P2/P3 candidates | Capacity — full band reached by the 19 items above | v8.2 candidate pool |
