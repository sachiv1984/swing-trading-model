...
| Item | Reason | Target |
|------|--------|--------|
| BLG-FEAT-56 | Gate not confirmed cleared (AI-touchpoint usage-validation sub-condition unconfirmable this session) | Unscheduled |
| BLG-FEAT-73 | SI-02 gate NOT MET; already parked by PO perennial-return disposition (2026-07-27) | Unscheduled |
| BLG-FEAT-74 | §13 pre-clearance not run; VH effort; same PO disposition | Unscheduled |
| BLG-FE-43 | Gate ("SI-05 sprint planning imminent") not met | Unscheduled |
| BLG-SPEC-35 | Gate ("PO-02 sprint planning imminent") not met | Unscheduled |
| BLG-FE-131, BLG-GOV-259, BLG-GOV-260, BLG-GOV-261, BLG-GOV-262, BLG-FEAT-86, BLG-OPS-122, BLG-QA-126 | Capacity — full band reached without these; ungated and available next cycle | v7.10 candidate pool |
