...
**Status:** Canonical
**Version:** 1.4
**Last Updated:** 2026-09-09 (ST-05, BLG-QA-82, v9.3 — §4 Playwright file pointer updated to consolidated signal-card.spec.js); prior — 2026-07-03 (ST-06, BLG-QA-61, v6.5 — reviewed against risk-based sizing, no changes needed); prior — 2026-04-18 (ST-03, v2.8 — added §5 Supplementary Indicator Field scenarios)
**Lifecycle Guide:** claude/charter/document_lifecycle_guide.md
**Derived from:** `docs/specs/frontend/pages/signals.md` v0.1; `docs/specs/api_contracts/signal_endpoints.md` v1.1
**Sprint:** 2026-03-18__release-v2.1 — ST-18 (closes TEST-GAP-SIG-01); 2026-04-17__release-v2.8 — ST-03; 2026-07-02__release-v6.5 — ST-06 (BLG-QA-61 review, no changes needed); 2026-09-09__release-v9.3 — ST-05 (BLG-QA-82, spec consolidation)
...
*Playwright file: `tests/e2e/signal-card.spec.js`* (consolidated from `signals-add-to-watchlist.spec.js` v9.3 ST-05, BLG-QA-82 — see Changelog)
...
| Version | Date | Change |
|---------|------|--------|
| 1.4 | 2026-09-09 | ST-05 (BLG-QA-82, EPIC-02, v9.3): `tests/e2e/signals-add-to-watchlist.spec.js` consolidated into `tests/e2e/signal-card.spec.js` (with 2 other overlapping SignalCard spec files) — updated §4 Playwright file pointer. No scenario content changed; SC-SIG-WL-01/02/03 still fully covered. QA & Testing Owner. |
