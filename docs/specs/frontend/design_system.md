...
**Status:** Canonical
**Version:** 1.17
**Last Updated:** 2026-09-15 (v9.4 sprint execution — ST-27/BLG-UX-04: Toast Notification Timing's non-conforming-screens inventory completed — 9 non-conforming call sites across 6 files, documentation only; corrects an under-count found at agent-mediated review); prior — 2026-09-15 (v9.4 sprint execution — ST-14/BLG-SPEC-137: new GBP-basis FX-conversion display pattern documented in §Consistency Rules); prior — 2026-09-14 (v9.4 design gate — ST-27/BLG-UX-04: new Toast Notification Timing standard, severity-based durations); prior history retained — see prior entries in version control
