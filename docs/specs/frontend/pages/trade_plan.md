...
**Status:** Active
**Version:** 1.8
**Last Updated:** 2026-08-18 (ST-05, EPIC-02, v8.9, BLG-FEAT-91 — implementation-time fix: DEV-v8.9-ST05-01, §5d.1 presence-gate corrected to Stop-Level-only; §5d.3 heat_impact_percent field name confirmed); prior — 2026-08-17 (v8.9 design gate — added §5d What-If Sizing Preview (ST-05) and §10.7 concentration-reason display (ST-04, BLG-BE-104)); prior — 2026-08-17 (ST-27, BLG-SPEC-129, EPIC-06, v8.8 — corrected §Changelog's stale anchor); prior history retained — see prior entries in version control.
