...
| Version | Date | Change |
|---------|------|--------|
| 2.4 | 2026-07-14 | v7.1 sprint execution: (ST-03, BLG-FE-107) Closed `DEV-EPIC01-ST05-01` — Table View's `AlertsCell` RISK OFF badge brought into spec compliance (`#1E40AF` blue-800, label "RISK OFF", no icon), matching the v7.0 Grid View badge. No spec text change — §Alerts Column was already correct; only §Known Deviations updated to record the resolution. |
