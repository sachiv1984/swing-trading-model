...
**Status:** Canonical
**Version:** 2.6.1
**Last Updated:** 2026-09-18 (ST-25, BLG-SPEC-133, EPIC-04, v9.5: corrected `current_trailing_stop_native` example value to reconcile with `current_trailing_stop × live_fx_rate`)
